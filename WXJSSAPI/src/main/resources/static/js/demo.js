...
wx.ready(function () {
  ...
  document.querySelector('#onMenuShareAppMessage').onclick = function () {
    wx.onMenuShareAppMessage({
      ...
      link: 'http://hzb.nat300.top/mp/test.jpg',
      imgUrl: 'http://hzb.nat300.top/mp/test.jpg',
  ...
  document.querySelector('#onMenuShareTimeline').onclick = function () {
    wx.onMenuShareTimeline({
      ...
      imgUrl: 'https://mmbiz.qpic.cn/mmbiz_jpg/KvOmwTNakatocDw4OajXN6ywEN7lJXS1ehtjoEqdokkyos9LQNu9BRGMvibian6mVPU8D22eYbs0zLomLxbTA1jQ/0?wx_fmt=jpeg',
      trigger: function (res) {
        // 不要尝试在trigger中使用ajax异步请求修改本次分享的内容，因为客户端分享操作是一个同步操作，这时候使用ajax的回包会还没有返回
        alert('用户点击分享到朋友圈');
      },
